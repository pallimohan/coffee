  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white p-6 rounded-lg shadow-md max-w-md w-full border border-brown-800">
        <h2 className="text-2xl font-bold text-brown-900 mb-4 text-center">Login</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-brown-800 text-white py-2 rounded hover:bg-brown-700 transition">Login</button>
        </form>
      </div>
    </div>
  );
